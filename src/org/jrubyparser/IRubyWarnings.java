...
public interface IRubyWarnings {
    ...
    public abstract void warn(ID id, SourcePosition position, String message, Object... data);
    ...
    public abstract void warning(ID id, SourcePosition position, String message, Object... data);
