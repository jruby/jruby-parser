...
public class ParserSupport {
    ...
    public void pushBlockScope() {
        currentScope = StaticScopeFactory.newBlockScope(currentScope, lexer.getFile());
    }

    public void pushLocalScope() {
        currentScope = StaticScopeFactory.newLocalScope(currentScope, lexer.getFile());
    ...
    public Node addRootNode(Node topOfAST) {
        ...
        return new RootNode(position, result.getScope(), topOfAST, lexer.getFile(), endPosition, false);
    }
    ...
    */
    public void initTopLocalVariables() {
        ...
        currentScope = scope == null ? StaticScopeFactory.newLocalScope(null) : scope;
    ...
    public void compile_error(String message) { // mri: rb_compile_error_with_enc
        ...
        throw new SyntaxException(PID.BAD_HEX_NUMBER, lexer.getFile(), lexer.getLineOffset(), line, errorMessage + message, "");
    }
