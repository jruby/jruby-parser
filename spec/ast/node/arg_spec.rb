...
describe Parser do
  it "parses a 0-arg method sans parens" do
  ...
  it "parses a 0-arg method with parens" do
    parse("def foo()\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
      expect(defn.args_node).to have_arg_counts(0, 0, false, false)
      expect(defn.args_node).to have_parameters()
  ...
  it "parses a 1-arg method sans parens" do
    parse("def foo a\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it "parses a 1-arg method with parens" do
    parse("def foo(a)\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
      expect(defn.args_node).to have_arg_counts(1, 0, false, false)
      expect(defn.args_node).to have_parameters('a')
  ...
  it "parses a 2-arg method sans parens" do
    parse("def foo a, b\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it "parses a 2-arg method with parens" do
  ...
  it "parses a 1-optarg method sans parens" do
    parse("def foo a=1\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it "parses a 1-optarg method with parens" do
    parse("def foo(a=1)\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
      expect(defn.args_node).to have_arg_counts(0, 1, false, false)
      expect(defn.args_node).to have_parameters('a')
  ...
  it "parses a rest-arg method sans parens" do
    parse("def foo *a\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it "parses a rest-arg method with parens" do
    parse("def foo(*a)\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
      expect(defn.args_node).to have_arg_counts(0, 0, true, false)
      expect(defn.args_node).to have_parameters(['a', '*a'])
  ...
  it "parses a block-arg method sans parens" do
    parse("def foo &a\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it "parses a block-arg method with parens" do
    parse("def foo(&a)\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
      expect(defn.args_node).to have_arg_counts(0, 0, false, true)
      expect(defn.args_node).to have_parameters(['a', '&a'])
  ...
  it "parses a mixed-arg method sans parens" do
  ...
  it "parses a mixed-arg method with parens" do
    parse("def foo(a, b, c = 1, *d)\nend\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name("foo")
  ...
  it 'parses a method with keyword arguments' do
    parse("def foo(a:, b: 1, c: true)\n end\n").find_node(:defn).tap do |defn|
      expect(defn).to have_name 'foo'
      ast = org.jrubyparser.ast
      req = ast.RequiredKeywordArgumentValueNode
      num = ast.FixnumNode
      true_node = ast.TrueNode
      expect(defn.args_node).to have_keywords a: req, b: num, c: true_node
    end
  end
end
